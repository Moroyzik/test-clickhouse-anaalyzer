 ...
 */
export function extractTableNames(result) {
 ...
 */
export function extractColumnReferences(result) {
 ...
 */
export function getStatementType(result) {
...
function statementKindToType(kind) {
